...
func check_event_conditions():
	...
	if time_elapsed == 32 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "I knew you’d call.",Fanatic_color , 6)
	if time_elapsed == 39 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "I don’t need your apologies.",Fanatic_color , 6)
	if time_elapsed == 46 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "What do you want?",Fanatic_color , 6)
	if time_elapsed == 53 :
	...
	if time_elapsed == 88 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "And say what ?", Fanatic_color, 6)
	if time_elapsed == 95 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "You want me to spill what we saw down there ?", Fanatic_color, 6)
	if time_elapsed == 102 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "You want me to burn it all ?", Fanatic_color, 6)
	if time_elapsed == 109 :
	...
	if time_elapsed == 144 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "You want me to be their memory… without being their witness.", Fanatic_color, 6)
	if time_elapsed == 151 :
	...
	if time_elapsed == 165 :
		talk("res://Music&Sound/sound/alarmpills_sound.mp3", "…I’ll think about it. But I won’t do it for you.", Fanatic_color, 6)
	if time_elapsed == 172 :
