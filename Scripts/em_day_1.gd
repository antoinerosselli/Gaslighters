...
func check_radio_conditions():
	...
	if time_elapsed >= 0 and time_elapsed <= 30:
		...
		if radio_value > 54 and radio_value < 64 and time_elapsed > gouv_time:
			play_radio_message("res://Voice/day1/gov/3. Security units.wav", "Security units are actively patrolling to maintain public order.", 5, gouv_color,"gouv", 0)
	if time_elapsed >= 40 and time_elapsed <= 90:
		if radio_value > 54 and radio_value < 64 :
			play_radio_message("res://Voice/day1/gov/4. The security room.wav", "Residents of the new miners' district can access a security room. An access device is located at the end of the main corridor.", 5, gouv_color, "gouv", 6)
		if radio_value > 54 and radio_value < 64 and time_elapsed > gouv_time:
			play_radio_message("res://Voice/day1/gov/5. The food rations.wav", "Rationing trucks are currently circulating in the city. Signal your presence by pressing the blue button on your security console.", 5, gouv_color, "gouv", 6)
		if radio_value > 54 and radio_value < 64 and time_elapsed > gouv_time:
			play_radio_message("res://Voice/day1/gov/6. The console.wav", "Check the operation of your console. If the blue light is visible through your front door, the system is operating normally.", 5, gouv_color, "gouv", 6)
		if radio_value > 54 and radio_value < 64 and time_elapsed > gouv_time:
			play_radio_message("res://Voice/day1/gov/7. The protective suit.wav", "After the rationing truck passes, your protective suit will be available for collection of your provisions.", 5, gouv_color, "gouv", 6)
		if radio_value > 54 and radio_value < 64 and time_elapsed > gouv_time:
	...
	if time_elapsed >= 160 and time_elapsed <= 230:
		if radio_value > 54 and radio_value < 64 :
			play_radio_message("res://Voice/day1/gov/1. Official Government Message.wav", "This is an official government message." , 5, gouv_color,"gouv", 6)
		if radio_value > 54 and radio_value < 64  and time_elapsed > gouv_time:
			play_radio_message("res://Voice/day1/gov/10. The mist deposits.wav", "Deposits of mist, visible as white spots, may appear in your homes. It is imperative to clean them immediately." , 5, gouv_color,"gouv", 6)
	...
	if time_elapsed >= 50 and time_elapsed <= 110:
		...
		if radio_value > 22 and radio_value < 32  and time_elapsed > belle_time:
			play_radio_message("res://Voice/day1/belle/imaalone.mp3", "I am alone in the studio, but I am here to share with you the latest news from Rock Valley, which is currently enveloped in a mysterious mist.",5, belle_color, "belle", 6)
		if radio_value > 22 and radio_value < 32  and time_elapsed > belle_time:
	...
	if time_elapsed >= 120 and time_elapsed <= 190:
		...
		if radio_value > 22 and radio_value < 32  and time_elapsed > belle_time:
			play_radio_message("res://Voice/day1/belle/agroupof.mp3", "Reports are coming in from all over the city: a group of unidentified individuals in suits has been seen.",5, belle_color, "belle", 6)
	...
	if time_elapsed >= 200 and time_elapsed <= 240:
		if radio_value > 22 and radio_value < 32 :
			play_radio_message("res://Voice/day1/belle/thisisbelle.mp3", "This is Belle,",5, belle_color, "belle", 6)
		if radio_value > 22 and radio_value < 32  and time_elapsed > belle_time:
			play_radio_message("res://Voice/day1/belle/whitespots.mp3", " White spots have started appearing here in the studio. I used ROCKCLEAN's EVERSPRAY and they disappeared.",5, belle_color, "belle", 6)
			Tools.event_journal_ok(3, false)
		if radio_value > 22 and radio_value < 32 and time_elapsed > belle_time:
	...
	if time_elapsed >= 250 and time_elapsed <= 300:
		if radio_value > 22 and radio_value < 32 :
			play_radio_message("res://Voice/day1/belle/thisisbelle.mp3", "This is Belle,",5, belle_color, "belle", 6)
		if radio_value > 22 and radio_value < 32  and time_elapsed > belle_time:
			play_radio_message("res://Voice/day1/belle/Oursources.mp3", "Our sources in the new miners' quarter report that each apartment is equipped with a cleaner.",5, belle_color, "belle", 6)
		if radio_value > 22 and radio_value < 32  and time_elapsed > belle_time:
	...
	if  time_elapsed >= 50 and time_elapsed <= 100:
		...
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
			play_radio_message("res://Voice/day1/complot/thisgovhasliedtoyou.mp3","The government has lied to you, betrayed our miners, and poisoned your children.",5, Fanatic_color, "fanatic", 6)
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
		...
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
			play_radio_message("res://Voice/day1/complot/SinceRockValley.mp3","Since Rock Valley joined the United Cities, our problems have multiplied, our local decisions overshadowed by distant bureaucracies.",5, Fanatic_color, "fanatic", 6)
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
	...
	if time_elapsed >= 110 and time_elapsed <= 190:
		if radio_value > 66 and radio_value < 76 :
			play_radio_message("res://Voice/day1/complot/myfriend.mp3","My friends,",5, Fanatic_color, "fanatic", 6)
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
			play_radio_message("res://Voice/day1/complot/Isntitsuspicious.mp3","Isn't it suspicious that the new government housing was ready to handle this crisis?",5, Fanatic_color, "fanatic", 6)
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
	...
	if time_elapsed >= 200 and time_elapsed <= 260:
		...
		if radio_value > 66 and radio_value < 76  and time_elapsed > Fanatic_time:
			play_radio_message("res://Voice/day1/complot/neardowntown.mp3","Near downtown, individuals have murdered a representative of our brave miners.",5, Fanatic_color, "fanatic", 6)
